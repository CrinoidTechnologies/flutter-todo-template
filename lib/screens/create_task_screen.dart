...
class _CreateTaskScreenState extends ConsumerState<CreateTaskScreen> {
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              CommonTextField(
                txtFieldKey: const Key('txt_title'),
                hintText: 'Task Title',
                title: 'Task Title',
              ...
              const Gap(30),
              CommonTextField(
                txtFieldKey: const Key('txt_notes'),
                hintText: 'Notes',
                title: 'Notes',
                maxLines: 6,
  ...
  void _createTask() async {
    ...
    if (title.isNotEmpty) {
      ...
      AppAlerts.displaySnackbar(context, S.current.titleCannotBeEmpty);
    }
  }
}
